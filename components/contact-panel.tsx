      ...
      <section className="space-y-6 rounded-md border border-[var(--border)] bg-[var(--surface)] p-6">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-sm leading-6 text-[var(--fg)]">
            Reach out for backend, ML/AI, data, automation, QA automation, or technical business analyst roles, project
            collaboration, or portfolio walkthroughs. Happy to correspond in English, French, or Arabic. This page is
            intentionally direct: no web form, no delivery uncertainty, just a clear route to email or profile links.
          </p>
        </div>
